...
% Specify a simulation stop time for the model
simStopTime = 12.8;
...
% Set the right scenario file name on the block
...
%% Design controller for lane following controller with spacing control
createLaneFollowingController
